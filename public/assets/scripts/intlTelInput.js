        ...
        function() {
            ...
            _createClass(Iti, [ {
                ...
                value: function _initRequests() {
                    var _this5 = this;
                    // if the profile has specified the path to the utils script, fetch it on window.load, else resolve
                ...
                value: function _updateFlagFromNumber(originalNumber) {
                    ...
                    // update flag if profile types area code for another country
